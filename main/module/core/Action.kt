...
val Actions.channel: ChannelAction
    get() = actions["channel"] as ChannelAction

val Actions.guild: GuildAction
    get() = actions["guild"] as GuildAction

val Actions.login: LoginAction
    get() = actions["login"] as LoginAction

val Actions.message: MessageAction
    get() = actions["message"] as MessageAction

val Actions.reaction: ReactionAction
    get() = actions["reaction"] as ReactionAction

val Actions.user: UserAction
    get() = actions["user"] as UserAction

val Actions.friend: FriendAction
    get() = actions["friend"] as FriendAction

val Actions.admin: AdminAction
    get() = actions["admin"] as AdminAction
...
class GuildAction private constructor(
    ...
    class MemberAction private constructor(val role: RoleAction, private val action: GeneralAction) : Action {
        constructor(platform: String, self_id: String, name: String, service: ActionService) : this(
        ...
        class RoleAction private constructor(private val action: GeneralAction) : Action {
            constructor(platform: String, self_id: String, name: String, service: ActionService) : this(
...
class LoginAction private constructor(private val action: GeneralAction) : Action {
    constructor(platform: String, self_id: String, name: String, service: ActionService) : this(
...
class ReactionAction private constructor(private val action: GeneralAction) : Action {
    constructor(platform: String, self_id: String, name: String, service: ActionService) : this(
...
class UserAction private constructor(val channel: ChannelAction, private val action: GeneralAction) : Action {
    constructor(platform: String, self_id: String, name: String, service: ActionService) : this(
...
class AdminAction private constructor(val login: LoginAction, val webhook: WebhookAction) : Action {
    ...
    class WebhookAction private constructor(private val action: GeneralAction) : Action {
        constructor(name: String, service: ActionService) : this(
